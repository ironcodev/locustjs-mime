...
// disclaimer: I obtained the mime list below some years ago. I cannot remember the source.
// we don't fill __mimes & __mimeTypes initially not to waste memory.
// these variables are only initialized at first call to Mimes and MimeTypes properties.

const _initMimes = function () {
	__mimes = [];
	[
